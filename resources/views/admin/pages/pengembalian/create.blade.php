                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.pengembalian.store') }}" method="post">
                        ...
                        <div class='form-group'>
                            <label for='peminjaman_id'>Peminjaman <span class='text-danger'>*</span></label>
                            <select name='peminjaman_id' id='peminjaman_id'
                                ...
                                @foreach ($data_peminjaman as $peminjaman)
                                    <option @selected($peminjaman->id == old('peminjaman_id')) value='{{ $peminjaman->id }}'>
                                        {{ $peminjaman->kode }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='datetime-local' name='tanggal_pengembalian' id='tanggal_pengembalian'
                                ...
                                value='{{ \Carbon\Carbon::now()->format('Y-m-d H:i') ?? old('tanggal_pengembalian') }}'>
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <textarea name='kondisi_mobil' id='kondisi_mobil' cols='30' rows='3'
                                class='form-control @error('kondisi_mobil') is-invalid @enderror'>{{ old('kondisi_mobil') }}</textarea>
                            @error('kondisi_mobil')
                                <div class='invalid-feedback'>
                                    {{ $message }}
                                </div>
                        ...
                        <div class='form-group'>
                            ...
                            <select name='status' id='status'
                                ...
                                <option value="4">Menunggu Pembayaran Denda</option>
                            </select>
                            @error('status')
                                <div class='invalid-feedback'>
                                    {{ $message }}
                        ...
                        <div class="form-group float-right">
                            ...
                            <button class="btn btn-primary">Tambah Pengembalian</button>
                        </div>
                    </form>
                </div>
            </div>
